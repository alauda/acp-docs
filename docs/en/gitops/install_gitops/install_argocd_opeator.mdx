...
i18n:
  title:
    en: Install Argo CD
    zh: 安装 Argo CD
title: Install Argo CD Opertator
---

# Install Argo CD

## Prerequisites
1. **Download** the **Argo CD** Operator installation package corresponding to your platform architecture. 
2. **Upload** the **Argo CD** installation package using the Upload Packages mechanism.
...
3. Find the **Argo CD** Operator, click **Install**, and navigate to the **Install Argo CD** page.
...
4. It is recommended to use the suggested default configuration; simply click **Install** to complete the **Argo CD** Operator installation.

### Create Argo CD Instance

1. Click **Marketplace** > **OperatorHub**.

2. Find the **Argo CD** Operator, click it to enter the **ArgoCD** detail info page.
...
1. Find the **Argo CD** Operator, click it to enter the **Argo CD** detail info page.
...
After completing the above procedure, you have successfully installed Argo CD. Immediately [Creating an application via Argo CD Dashboard](../how_to/create_application_by_argocd_dashoard.mdx) to begin your GitOps journey.
