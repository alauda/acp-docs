...
ACP GitOps abstracts the state of `Application` resources by leveraging the status of underlying Kubernetes resources. The state of `Application` resources directly governs the state of associated `ApplicationSet` resources.  
