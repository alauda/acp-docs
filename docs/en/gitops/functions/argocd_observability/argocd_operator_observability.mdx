...
## Prerequisites
- [Installing ACP GitOps](/gitops/install_gitops/install_gitops_plugin.mdx) is completed.
...
1. Login, and navigate to **Platform Management**, and select the `global` cluster.
