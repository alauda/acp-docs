...
title: Creating GitOps ApplicationSet
---
...
- **Installing ACP GitOps**:
  - If not installed, please contact the Administrator to [Installing ACP GitOps](/gitops/install_gitops/install_gitops_plugin.mdx).
