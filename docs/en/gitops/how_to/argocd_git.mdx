...
title: Integrating Code Repositories via Argo CD dashboard
---
...
- [Installing ACP GitOps](../install_gitops/install_gitops_plugin.mdx) is completed, and the **Noative Argo CD UI** switch has been enabled.
