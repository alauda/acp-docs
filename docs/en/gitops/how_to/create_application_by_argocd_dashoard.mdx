...
title: Creating an Argo CD Application via Argo CD dashboard
---
# Creating an Application through Argo CD dashboard

## Prerequisites

- Argo CD installed, meeting any of the following criteria:
