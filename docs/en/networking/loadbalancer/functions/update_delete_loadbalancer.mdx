...
4. Update the network and resource configuration as needed.
   ...
   - Please set specifications reasonably according to business needs. You can also refer to the relevant [Load Balancer Selection and Planning](./selection.mdx) for guidance.
