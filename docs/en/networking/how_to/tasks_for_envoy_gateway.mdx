...
1. [Create EnvoyGatewayCtl](../operators/envoy_gateway_operator.mdx)
2. [Create Gateway](../operators/envoy_gateway_operator.mdx#configure_gatewayapi_gateway)
3. [Create Route](../operators/envoy_gateway_operator.mdx#configure_gatewayapi_route)
...
We recommend using [EnvoyGatewayCtl](../operators/envoy_gateway_operator.mdx#envoygatewayctl) to manage those global configurations.
...
Manually retrieve the NodePort assignment by following [get nodeport from svc port](../operators/envoy_gateway_operator.mdx#get_nodeport_from_svc_port)
