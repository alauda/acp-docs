...
- **Network Configuration Requirements**
  ...
  - If workloads require multicast communication, the physical network must permit the required multicast groups and IGMP traffic. For configuration details, see [Configure Multicast for Kube-OVN Underlay Networks](./configure_underlay_multicast.mdx).
