...
:::warning
ALB has been deprecated. Please use the [ingress-nginx-operator](/networking/operators/ingress_nginx_operator.mdx) or [envoy-gateway](/networking/operators/envoy_gateway_operator.mdx) instead.
:::
...
The high availability of the **Load Balancer** requires a VIP. Please refer to [Configure VIP](/networking/operators/alb_operator/deploy_high_available_vip_for_alb.mdx).
...
- [Bind NIC](/networking/operators/alb_operator/bind_nic_in_alb.mdx)
...
![](../networking_assets/create_alb_via_web.png)
...
4. Update the network and resource configuration as needed.
   - Please set specifications reasonably according to business needs. You can also refer to the relevant [How to properly allocate CPU and memory resources](/networking/operators/alb_operator/decision_making_for_performance_selection_of_alb.mdx) for guidance.
...
8. [session_affinity_policy](/networking/operators/alb_operator/load_balancing_session_affinity_policy_in_alb.mdx)
...
![](../networking_assets/create_ft_via_web.png)
...
| ------------------- | -------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Timeout             | Configures the timeout settings for requests.                        | [timeout](/networking/operators/alb_operator/l4_l7_timeout.mdx)                   |
| Redirect            | Redirects incoming requests to a specified URL.                      | [redirect](/networking/operators/alb_operator/http_redirect.mdx)                  |
| CORS                | Enables Cross-Origin Resource Sharing (CORS) for the application.    | [cors](/networking/operators/alb_operator/cors.mdx)                               |
| Header Modification | Allows modification of request or response headers.                  | [header modification](/networking/operators/alb_operator/header_modification.mdx) |
| URL Rewrite         | Rewrites the URL of incoming requests before forwarding them.        | [url-rewrite](/networking/operators/alb_operator/url_rewrite.mdx)                 |
| WAF                 | Integrates Web Application Firewall (WAF) for enhanced security.     | [waf](/networking/operators/alb_operator/modsecurity.mdx)                         |
| OTEL                | Enables OpenTelemetry (OTEL) for distributed tracing and monitoring. | [otel](/networking/operators/alb_operator/otel.mdx)                               |
| Keepalive           | Enables or disables the keepalive feature for the application.       | [keepalive](/networking/operators/alb_operator/tcp_http_keepalive.mdx)            |
...
For more details, refer to [Balance Algorithm](/networking/operators/alb_operator/load_balancing_session_affinity_policy_in_alb.mdx).

### Operation On Rule

#### Using web console

![](../networking_assets/create_rule_via_web.png)
...
For more detailed information about monitoring metrics please refer to [ALB Monitoring](/networking/operators/alb_operator/alb_monitoring.mdx).
