...
Please ensure that you have read the [Installation](../operators/metallb_operator.mdx) documentation before proceeding.
...
## Configure an BGP Peers by using the web console \{#configure_bgp_peer}
