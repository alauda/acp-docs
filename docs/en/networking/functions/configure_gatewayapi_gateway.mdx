...
Please ensure that you have read the [Installation](../operators/envoy_gateway_operator.mdx#install_envoy_gateway_operator) documentation before proceeding.
...
By default, we use `Terminate` mode. Otherwise please refer to [ssl paasthrough](../how_to/tasks_for_envoy_gateway#ssl_passthrough).
