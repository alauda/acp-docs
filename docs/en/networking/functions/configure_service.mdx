...
1. **MetalLB deployed**: See [Creating External IP Address Pool](./configure_metallb.mdx#configure_ip_pool) for installation
2. **BGP Peer configured**: See [Creating BGP Peers](./configure_metallb.mdx#configure_bgp_peer) for BGP setup
