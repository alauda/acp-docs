...
Learn more [Configure Gateway API Gateway](../operators/envoy_gateway_operator.html#configure_gatewayapi_gateway).
...
Learn more [Configure Gateway API Route](../operators/envoy_gateway_operator.html#configure_gatewayapi_route).
...
Learn more about [BackendTrafficPolicy](../how_to/tasks_for_envoy_gateway.html#policyattachment-via-targetrefs).
...
1. Configure a [MetalLB IPAddressPool](../functions/configure_metallb.html#configure_ip_pool) and L2Advertisement.
