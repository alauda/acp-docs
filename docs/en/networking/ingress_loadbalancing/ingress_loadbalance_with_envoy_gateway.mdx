...
Learn more [Configure Gateway API Gateway](/networking/functions/configure_gatewayapi_gateway.mdx#configure_gatewayapi_gateway).
...
Learn more [Configure Gateway API Route](/networking/functions/configure_gatewayapi_route.mdx#configure_gatewayapi_route).
...
Learn more about [BackendTrafficPolicy](/networking/functions/configure_gatewayapi_policy.mdx#backendtrafficpolicy).
...
1. Configure a [MetalLB IPAddressPool](/networking/functions/configure_metallb.mdx#configure_ip_pool) and L2Advertisement.
