...
[Ingress-nginx](../ingress_nginx_operator.mdx) defines a series of annotations to configure the specific details of the authentication process. Below is a list of annotations that ALB supports, where "v" indicates support and "x" indicates no support.
