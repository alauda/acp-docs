...
4. Fill in the necessary parameters such as **Name**, **Image**, etc., in the form page. For detailed parameters and configuration, please refer to [Create Virtual Machine](/virtualization/virtual_machine/functions/create_virtual_machine.mdx).
...
4. Fill in the necessary parameters on the form page. For the image, select the exported Windows image. For detailed parameters and configuration, please refer to [Create Virtual Machine](/virtualization/virtual_machine/functions/create_virtual_machine.mdx).
