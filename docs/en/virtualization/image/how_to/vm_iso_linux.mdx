...
4. Fill in the parameters on the form page as follows. For specific parameters and configurations, please refer to [Create Virtual Machine](/virtualization/virtual_machine/functions/create_virtual_machine.mdx).
