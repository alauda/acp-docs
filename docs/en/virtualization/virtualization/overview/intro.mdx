...
| Cluster role | Grants |
| :-- | :-- |
| `kubevirt.io:view` | Read-only access to virtual machines and instances |
| `kubevirt.io:edit` | Create / update / delete virtual machines and open consoles |
| `kubevirt.io:admin` | Full virtual machine management, including subresources |
| `kubevirt.io:migrate` | Trigger live migrations |
