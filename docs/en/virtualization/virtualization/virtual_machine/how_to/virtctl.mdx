...
See [Uploading a Local Image and Creating a Virtual Machine](../../image/how_to/upload_local_image.mdx) for the full local-image upload and virtual-machine creation workflow, and [Exporting Virtual Machine Images](../../image/how_to/vm_image_export.mdx).
