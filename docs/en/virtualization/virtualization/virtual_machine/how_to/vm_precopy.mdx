...
Cluster-wide live-migration limits and per-namespace overrides are configured in the **new console** under **Virtualization** > **Live Migration** > **Migration Settings**.
