...
For specific creation steps, please refer to [Create HyperConverged Instance](/virtualization/virtualization/image/functions/environment.mdx#4).

### Prepare the Virtual Machine

**Note**: It is recommended to use the Kube-OVN Underlay network. For related configurations, please refer to [Create Subnet (Kube-OVN Underlay Network)](/configure/networking/functions/subnet_kubeovn_underlay.mdx).
