...
**Note**: It is recommended to use the Kube-OVN Underlay network. For related configurations, please refer to [Create Subnet (Kube-OVN Underlay Network)](/networking/subnet/functions/subnet_kubeovn_underlay.mdx).
