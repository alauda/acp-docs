...
4. Execute the following command to build the container image.
   ...
   ```bash
   podman build -t build-harbor.example.cn/3rdparty/vmdisks/winiso:2019 . # Replace the repository according to your actual environment
   ```
...
3. Execute the following command to build the container image.
   ...
   ```bash
   podman build -t build-harbor.example.cn/3rdparty/vmdisks/win-virtio:latest . # Replace the repository according to your actual environment
   ```
