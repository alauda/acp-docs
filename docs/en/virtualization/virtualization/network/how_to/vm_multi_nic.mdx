...
2. Switch to **YAML view** and add another nic to virtual machine
    ...
    Add new interface under `spec.template.spec.domain.devices.interface`
...
We supports hotplugging and unplugging network interfaces into a running Virtual Machine
