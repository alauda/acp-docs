...
- Only offline snapshots of the virtual machine are supported. Please first [stop the virtual machine](./batch_actions.mdx) before creating or rolling back to a snapshot.
