...
5. Refer to the [Create Internal Route](/application/building_application/functions/operation_after_creating/network_communications/service/create_service.mdx) page for quick addition of internal routes for the virtual machine.
