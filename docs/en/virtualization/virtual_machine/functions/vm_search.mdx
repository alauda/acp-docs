...
Ensure that the virtualization feature is enabled for the current cluster before use. Please refer to [Preparing the Virtualization Environment](/virtualization/image/functions/environment.mdx).
