...
View the storage usage data of mounted persistent volumes for reference when using computing components or applications. If the available capacity is insufficient, the persistent volume claim capacity can be expanded accordingly.
