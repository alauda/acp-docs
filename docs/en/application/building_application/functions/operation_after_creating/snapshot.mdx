...
Currently, the platform only supports creating volume snapshots using PVCs created from storage classes with **Dynamic Creation**. You can create new PVCs based on that snapshot and bind them.
