...
# Quick Deployment of a Simple Application Using Images

This document provides guidance on how to quickly deploy, manage, and access applications in a container platform.
