...
- Kubernetes allows configuring the duration for storing event information, with a default of 1 hour on the platform. Expired events are automatically cleaned up. To view more and more detailed event information, please click on [All Events](../../observability/log/functions/event.mdx).
:::
