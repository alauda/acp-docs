---
weight: 20
sourceSHA: 3489517b1e94fe97a7e391eb9ad6be153662a50ea4a6dfc69f727291b81ec27f
---

# In-depth Understanding of Operation and Maintenance Features
...
| **Reference**| Reference fields in **config maps or Opaque, username/password-type secrets** as environment variables. For related configuration parameters, please refer to [Config Map](/application/building_application/functions/preparation_before_creating/add_configmap.mdx) or [Secrets](/application/building_application/functions/preparation_before_creating/add_secret.mdx). |
...
For health check parameter description, please refer to [Health Checks](/application/building_application/functions/application_workloads/deployment_create.mdx).
...
For specific parameter descriptions, please refer to [Configuring Horizontal Scaling](/application/building_application/functions/operation_after_creating/add_hpa.mdx).
...
For specific parameter descriptions, please refer to [Creating Ingress Rules](/application/building_application/functions/operation_after_creating/network_communications/ingress/create_ingress.mdx).
...
Adds resource requests and limits for Pods. Please refer to [Resource Requests and Limits](/application/building_application/functions/application_workloads/deployment_create.mdx) for specific requests and limits descriptions.
