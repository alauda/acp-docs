...
Use the diagram as a high-level view of this model. The architecture details below clarify <Term name="productShort" /> 4.4 boundaries that are not visible in the diagram.
...
For detailed planning, sizing, component-level high availability, Global DR, and backup/restore entry points, see [Availability and Recovery](./availability-and-recovery.mdx).
