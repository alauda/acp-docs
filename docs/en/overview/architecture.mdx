...
* **Extensions**
  ...
  * **Aligned** – Released in sync with <Term name="productShort" /> Core, versioned together.
  * **Agnostic** – Versioned independently from <Term name="productShort" /> Core, with their own lifecycle.
