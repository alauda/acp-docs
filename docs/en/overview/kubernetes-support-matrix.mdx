...
Before onboarding a cluster, also verify:
...
- Compatibility metadata and documentation for each exact Operator or Cluster Plugin version that you plan to install.
