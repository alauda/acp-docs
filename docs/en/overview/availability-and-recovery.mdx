...
| Registry image repository data | Registry storage backup and recovery are backend-specific. | Contact technical support for a supported Registry backup and recovery plan. |
