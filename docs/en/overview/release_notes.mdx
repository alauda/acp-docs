...
- **Alauda Container Platform Registry for application images** — ACP 4.4 provides
  <Term name="product" /> Registry for application developers and workloads to push, pull, and manage
  application images. Administrators install and manage it with the Image Registry Operator and configure storage,
  ...
  collection separately when you need to reclaim unreferenced storage. For installation,
  configuration, access, and cleanup procedures, see [Registry administration](../configure/registry/index.mdx).
...
- <ExternalSiteLink name="keycloak" children="Alauda Application Services Identity Management E1" />
