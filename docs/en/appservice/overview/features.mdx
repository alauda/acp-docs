...
## Rich Application Service Support \{#compatible_sc}

- Supports various types of application services, including databases, caches, message queues, etc. The following are the main supported application service versions and compatible storage class information:

  | Application Service | Version                    | Data Persistence Compatible Storage Class | Backup Compatible Storage Class | Default Scheduling Rule (Single Instance)                                                                                    |
  | ------------------- | ------------------------- | --------------------------------------- | ------------------------------ | ----------------------------------------------------------------------------------------------- |
