...
## Alauda Application Services Advantages
...
The intuitive interface streamlines deployment and development, empowering developers to immediately leverage Alauda Application Services. Core capabilities are ready-to-use, enabling rapid and cost-effective service instance provisioning without complex configurations.
...
- Install dependencies
  ...
  Ensure that the target cluster has installed the dependent components of Alauda Application Services.
