...
The following customizations require administrator privileges and can be accessed through the Platform Management perspective.

### Customizing the Login Page

To customize the login page:

1. Navigate to the Platform Management perspective
...
### Customizing Perspective Names

To customize perspective names:

1. Navigate to the Platform Management perspective
2. Select "System Settings" from the navigation menu
3. Click on "Platform Parameters"
4. Under "Product Config," locate the perspective you want to rename
5. Update the "Name" field with your preferred name
6. Click "Save" to apply changes

The renamed perspective will appear in the perspective switcher and Portal page with the new name.

## Integrating External Products

You can integrate external product URLs into the platform, which will appear as perspective cards on the Portal page and in the perspective switcher.
...
Once integrated, the external product will appear as a card on the Portal page and in the perspective switcher. Clicking the card or selecting the perspective will navigate users to the specified URL.
