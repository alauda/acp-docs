...
The following customizations require administrator privileges and can be accessed through the **Administrator view**.
...
Administrators can customize the **left navigation menus** of the platform to hide, rename, or add navigation items for the **Administrator view** and **Projects view**.
