...
| Use GPU passthrough for virtual machines | [ACP Virtualization GPU passthrough documentation](../../virtualization/virtualization/virtual_machine/how_to/vm_gpust.mdx) |
...
- Virtual machine physical GPU passthrough is configured in [ACP Virtualization documentation](../../virtualization/virtualization/virtual_machine/how_to/vm_gpust.mdx).
