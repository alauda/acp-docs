...
- __A `RuntimeClass` named `nvidia`__ on the cluster. It is created when you configure the NVIDIA Container Toolkit as the container runtime, and the validation workload references it via `runtimeClassName: nvidia`.
