...
# CUDA Programming Compatibility Guide: Driver Version and Runtime Version Management Specifications
...
First reference NVIDIA's official statement:
...
### Virtualization Scenario Enhancements (HAMI/vGPU)
When using vGPU solutions like GPU-Manager or HAMI, additional constraints apply:

#### Version Requirements
```text
1. vGPU baseline version ≥ Runtime version
...
Label nodes based on supported CUDA versions:
```yaml
node_labels:
