...
1. [Install ingress-nginx](../../../networking/operators/ingress_nginx_operator.mdx)
...
Follow the instructions in [How To Add Pod Annotations In Envoy Gateway](./tasks_for_envoy_gateway.mdx#add_pod_annotation_in_envoy_gateway), setting the annotation to `endpoint-health-checker.io/enabled: 'true'`.
