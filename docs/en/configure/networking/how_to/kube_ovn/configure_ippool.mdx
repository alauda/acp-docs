...
1. To ensure compatibility with function *Fixed Addressess*, name of the IP pool cannot be an IP address.
2. IP addresses out of the subnet range is allowed, while these IPs will not be effective.
