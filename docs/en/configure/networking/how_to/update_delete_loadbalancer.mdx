...
4. Update the network and resource configuration as needed.
   ...
   - Please set specifications reasonably according to business needs. You can also refer to the relevant [Load Balancer Selection and Planning](../how_to/decide_performance_selection.mdx) for guidance.
