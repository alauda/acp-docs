...
:::warning
ALB has been deprecated. Please use the [ingress-nginx-operator](../how_to/install_ingress_nginx_via_ingress_nginx_operator.mdx) if you need to use ingress-nginx annotations.
