...
| Options | [options](#rule_options) | `.spec.rules[].filters`, `.spec.rules[].timeouts`, `.spec.rules[].retry` |
...
:::note
GRPCRoute does not support Options (timeout, retry, session persistence) configuration.
:::
