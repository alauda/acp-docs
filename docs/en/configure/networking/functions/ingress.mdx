...
| nginx.ingress.kubernetes.io/denylist-source-range                    | CIDR                       | o can achieve similar effect through [modsecurity](../how_to/modsecurity.mdx)                      |
| nginx.ingress.kubernetes.io/whitelist-source-range                   | CIDR                       | o can achieve similar effect through [modsecurity](../how_to/modsecurity.mdx)                      |
...
| nginx.ingress.kubernetes.io/modsecurity-transaction-id               | string                     | v [modsecurity](../how_to/modsecurity.mdx)                                 |
| nginx.ingress.kubernetes.io/modsecurity-snippet                      | string                     | v [modsecurity](../how_to/modsecurity.mdx)                               |
