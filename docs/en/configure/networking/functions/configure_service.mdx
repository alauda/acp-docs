...
1. **MetalLB deployed**: See [Creating External IP Address Pool](./create_metallb.mdx) for installation
2. **BGP Peer configured**: See [Creating BGP Peers](./create_bgppeer.mdx) for BGP setup
...
- [Creating BGP Peers](./create_bgppeer.mdx) for BGP peer setup
- [Creating External IP Address Pool](./create_metallb.mdx) for MetalLB configuration
