...
## Here is a full Kubernetes Demo that demonstrates:

1. How to access a Service inside a cluster (using ClusterIP).

2. How to access Service outside the cluster (using NodePort).
...
1. You can also temporarily run a test Pod:
