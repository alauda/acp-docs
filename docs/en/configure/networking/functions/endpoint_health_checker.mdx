...
4. In the deployment configuration dialog, you can optionally configure the following parameters:
   ...
   **Note**:
   - These configurations will be applied to Endpoint Health Checker components. If not specified, components will use their default scheduling configurations.
   - The configured node selectors and tolerations will be merged with the default settings.
