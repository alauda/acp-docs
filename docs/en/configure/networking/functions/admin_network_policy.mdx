...
4. Follow the instructions below to complete the relevant configuration.
   ...
   <table>
     ...
     <tbody>
       <tr>
         <td rowSpan={2}>Create Admin Network Policies/Configuring the Baseline Admin Network Policy</td>
       ...
       <tr>
         ...
         <td>Determines the order in which policies are evaluated and applied. Lower numerical values indicate higher priority.</td>
       </tr>
       ...
       <tr>
         ...
         <td>Specifies how to handle incoming traffic to target Pods. Has three modes: <b>Allow</b> (permits traffic), <b>Deny</b> (blocks traffic), and <b>Pass</b> (skips all lower-priority admin network policies, allowing the traffic to be handled by Network Policy, or if no Network Policy exists, by Baseline Admin Network Policy).</td>
       </tr>
