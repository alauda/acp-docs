...
* The Kubernetes version and parameters of the cluster must meet the [Standard Kubernetes Cluster Requirements](/overview/kubernetes-support-matrix.mdx#version-support-matrix).
