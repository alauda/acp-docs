...
2. If verification fails, please refer to the FAQ [How to trust an unsafe image registry?](/configure/clusters/managed/how-to/image-repo-trust.mdx).
...
Ensure network connectivity between the global cluster and the cluster to be imported. You must refer to [Network Configuration for Importing Clusters](/configure/clusters/managed/how-to/annotate-platform-url.mdx).
