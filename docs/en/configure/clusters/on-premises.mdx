...
**Recommendation**: Using a domain name for the Cluster Endpoint is recommended. If the VIP needs to be changed after cluster installation, using a domain name allows for easy DNS record updates without impacting cluster operations.
