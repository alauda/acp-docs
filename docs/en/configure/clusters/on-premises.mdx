...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      - The platform's network interface traffic monitoring by default recognizes traffic on interfaces named like <code>eth\.\|en\.\|wl\.*\|ww\.*</code>. If you use interfaces with different naming conventions, please refer to [Monitoring Custom Network Interfaces](/configure/clusters/how-to/monitoring_custom_network.mdx) after cluster onboarding to modify the relevant resources and ensure the platform can properly monitor network interface traffic.
    </td>
  </tr>
  <tr>
    <td><b>Node Name</b></td>
