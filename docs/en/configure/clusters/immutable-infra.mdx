...
<Term name="productShort" /> supports Immutable Infrastructure through pluggable infrastructure providers, each versioned independently from the platform. See <ExternalSiteLink name="immutable-infra" href="/overview/providers/index.html" children="Infrastructure Providers" /> for the full provider list and what each provider supports.
