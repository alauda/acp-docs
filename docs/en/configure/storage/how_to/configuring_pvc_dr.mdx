...
- **<Term name="product" /> Snapshot Management** has been deployed on both the Primary and Secondary clusters.
...
## Configuring a Scheduled Synchronization \{#configuring-a-scheduled-synchronization}
...
Configure synchronization from the Primary cluster to the Secondary cluster. For synchronization from the Secondary cluster to the Primary cluster, adapt the example below by swapping the cluster roles.
...
## Configuring a One-Time Synchronization \{#configuring-a-one-time-synchronization}
