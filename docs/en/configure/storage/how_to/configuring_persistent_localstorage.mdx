...
<Term name="productShort" /> can use local volumes for persistent storage. Local persistent volumes allow you to access local storage devices, such as a disk or partition, by using the standard persistent volume claim interface.
