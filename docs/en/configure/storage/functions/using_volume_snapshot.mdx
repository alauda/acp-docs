...
5. Click **Create**. Snapshot creation time depends on network conditions and data volume.
...
6. Click **Create**. Snapshot creation time depends on network conditions and data volume.
...
4. Click **Create**. Snapshot creation time depends on network conditions and data volume.
