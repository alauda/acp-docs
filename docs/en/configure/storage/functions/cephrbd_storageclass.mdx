...
5. Configure the parameters as required.
   ...
   | **Assign Project** | Assign the projects that can use this type of storage.<br />If no project currently needs this type of storage, leave the assignment empty and update it later.                                                                     |
