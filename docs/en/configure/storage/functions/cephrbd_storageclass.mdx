...
After clicking **Deploy**, on the **Distributed Storage** page, [Deploying in internal mode](/storage/storagesystem_ceph/installation/create_service_stand.mdx) or [Deploying in external mode](/storage/storagesystem_ceph/installation/access_storage_service.mdx).
