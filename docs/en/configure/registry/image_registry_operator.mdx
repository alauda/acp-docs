...
Setting the management state to `Removed` stops the Registry runtime components. Push and pull
traffic, the Image API server, and scheduled pruning are unavailable while the Registry is removed.
