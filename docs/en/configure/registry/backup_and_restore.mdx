...
# Legacy Registry Data Backup and Recovery

## Overview

Use this procedure to back up and recover legacy <Term name="productShort" /> Registry data when
registry image data is stored in S3-compatible object storage.
