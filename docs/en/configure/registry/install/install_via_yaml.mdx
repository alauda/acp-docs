...
# Legacy Registry: Install by Using YAML
...
| `spec.config.s3storage.region`                             | Region identifier for S3-compatible storage                   | `us-west-1`                   |
| `spec.config.s3storage.regionEndpoint`                     | S3-compatible service endpoint URL                            | `https://s3.example.com`      |
