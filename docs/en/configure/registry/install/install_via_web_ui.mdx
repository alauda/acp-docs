...
# Legacy Registry: Install by Using the Web Console
...
## Prerequisites
- **Install** the **<Term name="product" /> Registry** Cluster Plugin to a target cluster using the [Cluster Plugin](/extend/cluster_plugin.mdx) mechanism.

## Install <Term name="product" /> Registry Using the Web Console
...
3. Locate the **<Term name="product" /> Registry** Cluster Plugin, click **Install**, then proceed to the installation page.
...
You can update or uninstall the **<Term name="product" /> Registry** plugin from either the list page or details page.
