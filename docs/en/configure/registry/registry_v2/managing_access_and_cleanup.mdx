...
| Placeholder | Description |
| --- | --- |
| `sha256:<digest>` | Digest of the Image object to verify. Use `ac get images -n <namespace>` for a namespace-specific image list. When tag digest details are required, query the ImageStreamTag details for that namespace. |
