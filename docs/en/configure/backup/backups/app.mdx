...
2. Click **Execute Backup** on the right of the schedule, then confirm.
...
2. Click the ***Backup Schedule Name*** of the backup record to be deleted.

3. In the **Backup Records** area, click the **Export Log** button on the right side of the backup record.