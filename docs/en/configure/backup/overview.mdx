...
Registry backup and restore depend on the configured storage backend and recovery requirements.
Contact technical support for a supported Registry backup and recovery plan.
