...
**Immutable OS design**: The operating system layer is read-only and managed centrally by platform. When a node fails, platform automatically creates a new node with correct configuration.
...
* **Application data**: Use PV snapshots/replication for persistent volumes
