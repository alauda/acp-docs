...
* To ensure reliability and data integrity, do not back up database data (for example, MySQL, Redis). Use Data Services for database backups.
...
3. Click **Create Backup Policy** > **Create Application Backup** and configure the parameters as follows.
    ...
    * **Backup Repository**: Select a repository that has passed connectivity verification, or click [Create Backup Repository](./repository.mdx). After creating a repository, click **OK and Create Application Backup** to return and continue.
