...
6. Click **YAML** in the upper-right corner to switch to YAML editing mode. Refer to [Configuring Hooks](./backup-app.mdx#hooks) to configure commands that run during recovery.
