...
- Alauda Container Platform Cluster Enhancer is installed in the current cluster. For installation instructions, see [etcd installation](../overview.mdx#etcd-installation).
