...
* Prepare nodes before adding them to the cluster. Use the [Node Availability Check Reference](/install/prepare/node_preprocessing.mdx#node_checks) to verify the nodes. Cluster deployment can fail when required conditions are not met.
...
4. Configure the relevant parameters. For parameter details, see [Node Configuration Parameters](/configure/clusters/on-premises.mdx#node-settings).
