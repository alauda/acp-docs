...
For Kubernetes taint and toleration behavior, see [Taints and Tolerations](https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/).
...
**Tip**: For related operations and precautions, see [Prepare Virtualization Environment](/virtualization/virtualization/overview.mdx).
