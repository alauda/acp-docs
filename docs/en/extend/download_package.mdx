...
--appID              show detailed information for the specified app ID
```
...
For v3.x versions, the tool downloads the full package set by default — you do not need to set this option.  
