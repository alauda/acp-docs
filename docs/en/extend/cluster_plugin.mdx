...
A cluster plugin is a tool for extending the platform's functionality and can be either a component or a platform module. Each plugin is managed through three cluster-level CRDs: **ModulePlugin**, **ModuleConfig**, and **ModuleInfo**.
...
```shell
# kubectl get moduleinfo cpaas.io/module-name=gpu-device-plugin
NAME                                      CLUSTER   MODULE              DISPLAY_NAME        STATUS    TARGET_VERSION   CURRENT_VERSION   NEW_VERSION
