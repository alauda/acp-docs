...
- At least 1 [Device Class (deviceClasses.classes)](/storage/storagesystem_topolvm/installation.mdx) must have been added when creating the local storage cluster, including devices in the device class.
