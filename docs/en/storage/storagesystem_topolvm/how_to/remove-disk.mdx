---
weight: 62
title: Remove Disks, Device-Class Volume Groups, or Nodes from LVM Storage
---

# Remove Disks, Device-Class Volume Groups, or Nodes from LVM Storage

This document describes how to remove failed disks, remove device-class volume groups from a device class, and remove storage nodes in LVM Storage.
