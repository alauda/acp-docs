...
This chapter documents **LVM Storage**. The Marketplace package name remains **Alauda Build of TopoLVM**. For statically provisioned whole-disk or partition PersistentVolumes, see [Local Storage](../local_storage/index.mdx).
