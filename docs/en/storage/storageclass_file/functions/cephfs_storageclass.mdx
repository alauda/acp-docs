...
After clicking **Deploy**, on the **Distributed Storage** page, [Create Storage Service](/storage/storagesystem_ceph/functions/create_service_stand.mdx) or [Access Storage Service](/storage/storagesystem_ceph/functions/access_storage_service.mdx).
