...
- LVM Storage and Ceph Internal Mode use this operator for **Selection Device**. See [Install LVM Storage](../storagesystem_topolvm/installation.mdx) and [Deploying in Internal Mode](../storagesystem_ceph/installation/create_service_stand.mdx).
