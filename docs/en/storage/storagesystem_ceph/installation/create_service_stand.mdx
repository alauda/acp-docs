...
To use **Selection Device** when adding storage devices, install **Alauda Build of LocalStorage** first. It discovers unused disks on cluster nodes and writes `LocalVolumeDiscoveryResult` objects. **Input Device** does not require this operator.

See [Install Local Storage](../../local_storage/installation.mdx).
