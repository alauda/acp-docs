...
This document only describes the parameters that differ from internal mode deployment; for other parameters, please refer to [Deploying in Internal Mode](./create_service_stand.mdx).
...
For details, please refer to [Deploying in Internal Mode](./create_service_stand.mdx).
