...
- Prepare two clusters capable of deploying Alauda Container Platform Build of Ceph: a Primary cluster and a Secondary cluster, with network connectivity between them.
