...
availability zone within which replicas of the data are spread to ensure high availability. **Aluda Build of Rook-Ceph** automatically identifies these failure domains based on the labels assigned to the storage
nodes.
