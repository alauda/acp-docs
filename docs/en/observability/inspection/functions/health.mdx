...
The platform health status page presents statistical data on the health status of features that have been deployed on the platform. When your account has management or auditing permissions related to the platform, you can also view detailed health data for specific features, including: a list of clusters that do not have the feature deployed, the health status of clusters that have the feature deployed, and detection data for components within clusters associated with the feature. This can help you quickly identify issues and improve the operational efficiency of the platform.

## Steps to Operate

1. Navigate to the view page of deployed products or the platform center (platform management, project management, operations center).
