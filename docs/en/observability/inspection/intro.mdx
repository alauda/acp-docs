...
- Supports online execution of inspection tasks, including resource risk inspections of all clusters, nodes, container groups, and certificate resources on the platform, as well as usage inspections of regular resources, allowing real-time tracking of inspection progress;
