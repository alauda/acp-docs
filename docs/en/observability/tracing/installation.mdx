...
i18n:
  title:
    en: Installation
sourceSHA: 8bc4d4e85fadde463f6fa20479a480f45f5cb9d9a3cb35a248bec17c445c0408
title: Installation
---
...
You can install the Jaeger Operator from the Alauda Container Platform **App Store Management** → **Operators** section where the available Operators are listed.

**Steps**

- In the **Platform Management** view of the Web Console, select the **cluster** where you want to deploy the Jaeger Operator, then navigate to **App Store Management** → **Operators**.

- Use the search box to search for `Jaeger Operator` in the catalog. Click on the **Jaeger Operator** title.

- Read the introductory information about the Operator on the **Jaeger Operator** page. Click **Deploy**.
...
- On the **Deploy** page:
  ...
  - Choose **Recommended Namespace** for **Namespace**. Install the Operator in the recommended `jaeger-operator` namespace, so the Operator can monitor and be available in all namespaces within the cluster.

- Click **Deploy**. You will see the Operator on the **Deployed Operators** page.

- Verify that the **Status** displays as **Deployment Successful** to confirm the Jaeger Operator was installed correctly.
...
You can install the OpenTelemetry Operator from the Alauda Container Platform **App Store Management** → **Operators** section where the available Operators are listed.

**Steps**

- In the **Platform Management** view of the Web Console, select the **cluster** where you want to deploy the OpenTelemetry Operator, then navigate to **App Store Management** → **Operators**.

- Use the search box to search for `OpenTelemetry Operator` in the catalog. Click on the **OpenTelemetry Operator** title.

- Read the introductory information about the Operator on the **OpenTelemetry Operator** page. Click **Deploy**.

- On the **Deploy** page:

  - Select **Manual** for the **Upgrade Strategy**. For the `Manual` approval strategy, OLM will create update requests. As a cluster administrator, you must manually approve the OLM update requests to upgrade the Operator to the new version.
  - Select the **alpha channel**.
  - Choose **Recommended Namespace** for **Namespace**. Install the Operator in the recommended `opentelemetry-operator` namespace, so the Operator can monitor and be available in all namespaces within the cluster.

- Click **Deploy**. You will see the Operator on the **Deployed Operators** page.

- Verify that the **Status** displays as **Deployment Successful** to confirm the OpenTelemetry Operator was installed correctly.
...
- From **App Store Management** → **Operators** → **Deployed Operators** page, use the **search box** to search for `opentelemetry-operator`.
- Click on the **opentelemetry-operator** name to enter its details.
- On the **opentelemetry-operator** details page, click **Actions** → **Uninstall Operator**.
- In the **Are you sure you want to uninstall opentelemetry-operator?** window, click **Uninstall**.
...
- From **App Store Management** → **Operators** → **Deployed Operators** page, use the **search box** to search for `jaeger-operator`.
- Click on the **jaeger-operator** name to enter its details.
- On the **jaeger-operator** details page, click **Actions** → **Uninstall Operator**.
- In the **Are you sure you want to uninstall jaeger-operator?** window, click **Uninstall**.
