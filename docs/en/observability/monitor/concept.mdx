...
A dashboard is a collection of multiple related charts, providing an overall view of the system status. It supports flexible layout arrangements and can organize charts in rows or columns.

### Charts

Charts are visual representations of monitoring data, supporting various display types.
