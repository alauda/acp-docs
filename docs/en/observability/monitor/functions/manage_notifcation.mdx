...
- **Notification Strategy**: A notification strategy is a collection of rules defining how to send notification messages to specific contacts. It is essential to use a notification strategy for scenarios such as alerts, inspections, and login authentication that require notifying external services.
...
| **Strategy Name**| `{{ .labels.alert_resource }}`                                            | The name of the alert strategy, e.g., cpaas-node-rules.     |
| **Alert Description**| `{{ .externalLabels.summary }}`                                         | Description of the alert strategy.          |
...
## Notification Strategy {#notification}

A notification strategy is a collection of rules defining how to send notification messages to specific contacts. It is essential to use notification strategies for scenarios requiring notification to external services, such as alerts, inspections, and login authentication.
...
2. Click **Create Notification Strategy** and configure the relevant parameters as per the following instructions.
...
## Set Notification Strategy for Projects
...
5. Switch to the **Notification Strategy** tab, refer to [Notification Strategy](#notification) to create a notification strategy.
