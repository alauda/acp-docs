...
:::warning
The `/v2/metrics` endpoints used in the examples on this page are deprecated in ACP 4.4 and are planned for removal in a future release. Use the `/platform/monitoring.alauda.io/v1beta1` endpoints instead. For more information, see [Monitoring APIs](/apis/advanced_apis/monitor/index.mdx).
:::
