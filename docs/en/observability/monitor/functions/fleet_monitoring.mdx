...
This dashboard reads Fleet-level rollup metrics that are evaluated once per hour on the Global cluster. A newly created project or a newly connected cluster can take up to about one hour to appear on this dashboard.
