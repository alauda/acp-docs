...
- When install in a business cluster, ensure that the global cluster can access port 11780 of the business cluster.
...
## Install the Monitoring with Prometheus Plugin
...
3. Configure the following parameters:
   ...
   | **Replica Count**      | Sets the number of monitoring component container groups<br />**Note**: Prometheus supports only single-node installation                                            |
...
## Install the Monitoring with VictoriaMetrics Plugin
