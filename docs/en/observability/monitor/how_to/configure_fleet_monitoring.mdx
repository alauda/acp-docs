...
- The Global cluster has VictoriaMetrics enabled and has an available write endpoint. Prometheus-only Monitoring is not sufficient because connected clusters write Fleet Monitoring data to the Global VictoriaMetrics storage.
