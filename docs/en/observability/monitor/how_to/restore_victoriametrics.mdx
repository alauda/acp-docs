...
- The Monitoring with VictoriaMetrics plugin has been deployed in the cluster
...
**Note**: The name of the computing component in the Monitoring with VictoriaMetrics plugin is `vmstorage-cluster`, and its type is `StatefulSet`.
