...
- Port Access: If installing log storage components in a business cluster, ensure that the `global` cluster can access port 11780 of the business cluster.
...
- Installation Planning: The platform supports the installation of log storage components in any cluster; logs from any cluster can be collected in advance to the log storage components of a designated cluster. Please plan the installation of log-related components based on your data center layout to avoid excessive bandwidth costs due to cross-domain traffic.
