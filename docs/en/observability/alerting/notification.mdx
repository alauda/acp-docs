...
- <Term name="productShort" textCase="upper" /> version: >= v4.2
- Plugin version: >= v1.0
...
Log in to the package portal and download the latest <Term name="product" /> Cluster Notification plugin package.

### Push the Plugin to Platform with violet

Use violet to push the <Term name="product" /> Cluster Notification plugin to the platform:
...
This section provides the upgrade path principles and supported version compatibility for <Term name="product" /> Cluster Notification.

:::

### Compatibility Matrix

The table below lists supported versions of <Term name="product" /> Cluster Notification:

| Cluster Notification Version | Supported <Term name="productShort" textCase="upper" /> Version |
|------------------------------|-----------------------------------------------------------------|
| v1.0.1                       | v4.2 and later                                                  |
| v1.0.0                       | v4.2 and later                                                  |

### Upgrade Path Guidelines

#### Patch-Level Upgrade

- **Description**: Cluster Notification supports patch-level upgrades within the same minor version and can be upgraded directly.
- **Prerequisite**: <Term name="productShort" textCase="upper" /> version must satisfy the compatibility matrix above.
