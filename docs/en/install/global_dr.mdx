...
Example of uploading extensions to the standby cluster:

```bash
violet push extensions/* --skip-crs \
    --platform-address "https://example.com" --platform-username "admin" --platform-password "platform pass" \
