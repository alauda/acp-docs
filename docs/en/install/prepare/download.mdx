...
2. In the Customer Portal, go to **Marketplace > Batch Download > Install > Scenarios** and download **Common ACP Extensions** for the same <Term name="productShort" /> version and architecture.
