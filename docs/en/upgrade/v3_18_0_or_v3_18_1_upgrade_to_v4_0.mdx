...
# Upgrade <Term name="productShort" /> v3.18.0 or v3.18.1 To v4.0
...
2. Refer to the [Upload Platform Images](#upload-platform-images) paragraph to upload the platform images to the **standby cluster** .
3. Refer to the [Upgrade the global cluster](#upgrade-the-global-cluster) paragraph to upgrade the **standby cluster's** global.
4. Wait for the upgrading of **standby cluster's** global to complete.
