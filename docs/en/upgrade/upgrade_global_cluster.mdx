...
2. If the application is listed in **ACP Upgrade to v4.4**, download its package, copy it into the extracted Core Package's `plugins/` directory, and rerun `upgrade.sh --only-sync-image`.
