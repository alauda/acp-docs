...
:::warning
1. If you plan to upgrade the **Operator** and **Cluster Plugin** while upgrading the workload cluster, please push the corresponding packages to the corresponding cluster's registry in advance.
