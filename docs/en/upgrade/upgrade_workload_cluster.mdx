...
If a service mesh is installed in any cluster, refer to the <ExternalSiteLink name="servicemesh" href="/main/upgrade.html" children="Service Mesh Upgrade Guide" /> for detailed upgrade instructions.
