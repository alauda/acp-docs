...
B --> C{Is Disaster Recovery Environment (DR)?}
C -->|Yes| D{Execute DR Upgrade Documentation}
C -->|No| E[Execute Global Upgrade Documentation]
D -->|Yes| E
E --> F[Backup]
F --> G[Upload Platform Images]
G --> H[Upgrade Global Cluster]
H --> I[Execute Business Cluster Upgrade Documentation]
I --> J[Upgrade Business Cluster Basic Components]
