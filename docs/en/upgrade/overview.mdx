...
- **availableUpdates**: The list of upgrade targets currently exposed to the cluster. For workload clusters, target versions are typically exposed only after the global tier has already reached the same Distribution Version.
