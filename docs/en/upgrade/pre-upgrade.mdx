...
<Tabs>
  ...
  | Condition | Requirement | If Not Met |
  | --------- | ----------- | ---------- |
  | **Kubernetes version** | All clusters must be on **1.28 or later** | Upgrade Kubernetes before proceeding |
  | **Service mesh (Istio)** | Version must be **1.20** | Upgrade Istio first |
