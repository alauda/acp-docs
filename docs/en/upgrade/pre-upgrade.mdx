...
2. On the **Global** cluster control node, or on an operations host that can access the platform, run `violet list` to list the extensions in the current environment and export the output to `./apps.yaml`.
