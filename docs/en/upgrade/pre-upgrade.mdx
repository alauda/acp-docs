...
From v4.2, we add a new plugin called **Alauda Container Platform Log Essentials**. If you installed log storage plugin before, you need to upload this plugin before upgrading.
