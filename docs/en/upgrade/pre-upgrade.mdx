...
2. Use the "violet list" command to list the extensions in the current environment and export the output in YAML format.

3. Import the exported YAML file into the Alauda Customer Portal to align the extension list.
