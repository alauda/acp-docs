...
From the **<Term name="company" /> Customer Portal**, click **Extensions** and select the scenario: **`For upgrading ACP from 3.18.x to 4.1.x`**.
</Tab>

<Tab label="From 3.18.x to 4.0.x">
From the **<Term name="company" /> Customer Portal**, click **Extensions** and select the scenario: **`For upgrading ACP from 3.18.x to 4.0.x`**.
</Tab>

<Tab label="From 3.16.x to 4.0.x">
From the **<Term name="company" /> Customer Portal**, click **Extensions** and select the scenario: **`For upgrading ACP from 3.16.x to 4.0.x`**.
</Tab>
</Tabs>
