...
5. After it finishes, import the generated `apps.yaml` back into the Custom Portal to align the extensions list.
...
- If Elasticsearch is installed, you must apply the solution **"How to Correct the Issue of Node Role Settings in Big Cluster Elasticsearch"** before upgrading. The solution is available in **Custom Portal > Knowledge**.  
</Tab>
