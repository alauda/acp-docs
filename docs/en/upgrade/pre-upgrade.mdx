...
| --------- | ----------- | ---------- |
| **Kubernetes** | All clusters running **1.30 or later** | Upgrade Kubernetes BEFORE proceeding |
| **Service mesh (Istio)** | All clusters running **1.22 or later** | Upgrade Istio and its instances BEFORE proceeding |
