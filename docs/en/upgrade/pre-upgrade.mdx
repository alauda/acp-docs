...
As an alternative to Violet, in the Customer Portal, go to **Marketplace > Batch Download > Install > Scenarios** and download **ACP Upgrade to v4.4** for the same target version and architecture as the Core Package.
