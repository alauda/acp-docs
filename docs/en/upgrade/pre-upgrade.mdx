...
ACP 4.0.x cannot be upgraded directly to ACP 4.4. Upgrade the environment to a supported 4.1.x, 4.2.x, or 4.3.x release first, and then upgrade to ACP 4.4.
