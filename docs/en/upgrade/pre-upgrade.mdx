...
:::warning
If you used the feature of **`global` Cluster Platform Node Isolation** when you install the platform , You need to contact technical support to get the corresponding solution.
:::