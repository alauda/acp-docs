...
From v4.2, we add a new plugin called **Alauda Container Platform Log Essentails**. If you used log storage plugin before,you need to download this plugin and complete the upload operations.
