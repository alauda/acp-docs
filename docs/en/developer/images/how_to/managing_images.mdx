...
To pull a secured container from other private or secured registries, you must create a pull secret from your container client credentials, such as `Podman`, and add it to your service account.

Container clients use a configuration file to store authentication details to log in to secured or insecure registry:
