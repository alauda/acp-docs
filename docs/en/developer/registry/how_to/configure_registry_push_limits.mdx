...
# Legacy Registry: Configure Registry Push Limits
...
- If you have not installed the legacy Registry yet, see [Legacy Registry: Install by Using YAML](/configure/registry/install/install_via_yaml.mdx).
