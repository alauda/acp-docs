...
Use this page to access <Term name="productShort" /> Registry from inside the cluster, from external
clients, and through the <Term name="productShort" /> Image API.

## Prerequisites

- <Term name="productShort" /> Registry is installed and available in the target cluster.
