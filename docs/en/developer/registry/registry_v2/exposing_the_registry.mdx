...
By default, workloads inside the cluster should use the internal registry service. Expose **Registry v2** only when developer machines, CI systems, or other external clients must push or pull images.
