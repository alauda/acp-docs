...
Use this page to access the Operator-managed <Term name="productShort" /> Registry from inside the
cluster, from external clients, and through the <Term name="productShort" /> Image API.

## Prerequisites

- The Operator-managed Registry is installed and available in the target cluster.
...
For role binding examples, see [Managing access and cleanup](../../../configure/registry/registry_v2/managing_access_and_cleanup.mdx).
