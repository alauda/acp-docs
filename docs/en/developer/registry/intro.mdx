...
Deeply integrated into the platform architecture, ACP Registry provides tighter platform collaboration, simplified configuration, and greater internal access efficiency than an external, independently deployed image repository.
