...
- Obtain a registered **domain**, such as `registry.example.com`. For domain configuration, see [Create a Domain](/configure/networking/functions/configure_domain.mdx).
