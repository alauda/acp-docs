...
1. On the **Platform Management** page, click **Marketplace** > **Cluster Plugins** to enter the **Cluster Plugins** list page. Find the **Alauda Container Platform Registry** cluster plugin. Verify that its state is **Installed**.
