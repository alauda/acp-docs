...
# Installing ACP Registry

## Prerequisites
1. **Install** the **ACP Registry** cluster plugin to a target cluster using the Cluster Plugins mechanism.

## Installing ACP Registry cluster plugin using the web console

### Procedure

1. Login, go to the **Platform Management** page.
2. Click **Marketplace** > **Cluster Plugins** to enter the **Cluster Plugins** list page.
3. Find the **ACP Registry** cluster plugin, click **Install**, and navigate to the **Install ACP Registry** page.
4. Configure parameters by referencing the following specifications; click **Install** to complete the **ACP Registry** cluster plugin installation.
...
1. On the **Platform Management** page, click **Marketplace** > **Cluster Plugins** to enter the **Cluster Plugins** list page. Find the **ACP Registry** cluster plugin. Verify that its state is **Installed**.
2. Click **ACP Registry** name to enter the **ACP Registry** cluster plugin details page.
...
## Updating/Uninstalling ACP Registry

Updating or uninstalling of the **ACP Registry** can be performed on both the list page and the detail page.
