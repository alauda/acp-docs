...
# Install Alauda Container Platform (ACP) Registry

## Prerequisites
1. **Install** the **Alauda Container Platform (ACP) Registry** cluster plugin to a target cluster using the Cluster Plugins mechanism.

## Installing Alauda Container Platform (ACP) Registry cluster plugin using the Web Console

### Procedure

1. Login, go to the **Platform Management** page.
2. Click **Marketplace** > **Cluster Plugins** to enter the **Cluster Plugins** list page.
3. Find the **Alauda Container Platform (ACP) Registry** cluster plugin, click **Install**, and navigate to the **Install Alauda Container Platform (ACP) Registry** page.
4. Configure parameters by referencing the following specifications; click **Install** to complete the **Alauda Container Platform (ACP) Registry** cluster plugin installation.
...
1. On the **Platform Management** page, click **Marketplace** > **Cluster Plugins** to enter the **Cluster Plugins** list page. Find the **Alauda Container Platform (ACP) Registry** cluster plugin. Verify that its state is **Installed**.
2. Click **Alauda Container Platform (ACP) Registry** name to enter the **Alauda Container Platform (ACP) Registry** cluster plugin details page.
...
## Updating/Uninstalling Alauda Container Platform (ACP) Registry

Updating or uninstalling of the **Alauda Container Platform (ACP) Registry** can be performed on both the list page and the detail page.
