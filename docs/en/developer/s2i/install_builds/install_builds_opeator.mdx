...
2. Utilize the [Upload Packages] management capability to list **ACP Builds** and **Tekton** packages on the web console, and distribute them to all clusters that require S2I capabilities. 
