...
2. Utilize the `violet` CLI tool to upload **Alauda Container Platform Builds** and **Tekton** packages to your target cluster. For detailed instructions on using `violet`, please refer to the [CLI](/ui/cli_tools/index.mdx).
