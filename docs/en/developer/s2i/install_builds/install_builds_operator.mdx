...
| **Upgrade Strategy** | Please select the `Manual`. <ul><li>`Manual`: When a new version is available in the OperatorHub, the **Upgrade** action will not be executed automatically.</li></ul> |
