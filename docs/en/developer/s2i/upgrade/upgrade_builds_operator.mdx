...
If you are upgrading from version v4.0 and earlier, first migrate the [**Alauda DevOps Tekton v3** to **Alauda DevOps Pipelines**](https://docs.alauda.io/devops/4.0/upgrade/migrating-tekton-v3-to-v4.md.html).
</Directive>
