...
- Access to an image repository is required. If no repository is available, contact the administrator to [prepare the Registry](/configure/registry/index.mdx).
