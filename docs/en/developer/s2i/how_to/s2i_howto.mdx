...
- There is an accessible image repository on the platform. If not, please contact the Administrator to [Installing Alauda Container Platform Registry](/developer/registry/install/index.mdx)
