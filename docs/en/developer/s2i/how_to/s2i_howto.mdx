...
- There is an accessible image repository on the platform. If no repository is available, contact the administrator to [prepare the Registry](/configure/registry/index.mdx).
