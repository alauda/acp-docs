...
- There is an accessible image repository on the platform. If not, please contact the Administrator to [Install Alauda Container Platform (ACP) Registry](../../image/install_registry.mdx).
