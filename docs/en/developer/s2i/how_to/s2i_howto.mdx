...
# Creating an custom application from Code
...
1. In the left navigation bar, click on **Application Management** -> **Applications**.
...
6. You can check the corresponding application status on the **Details** information page.
