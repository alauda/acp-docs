...
After a policy is created or updated, the platform labels related `Node`, `ProjectQuota`, and `Namespace` resources, and injects scheduling constraints when Pods are created or updated. Common labels and taints include:
...
7. Check the `Node`, `ProjectQuota`, and `Namespace` labels.
