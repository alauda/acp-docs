...
i18n:
  title:
    ...
    zh: 快速创建一个应用
title: Quickly creating a simple application via image
---

# Quickly creating a simple application via image
...
### Creating a simple application using Deployment \{#deployment}
...
### Expose application by using Service \{#service}
