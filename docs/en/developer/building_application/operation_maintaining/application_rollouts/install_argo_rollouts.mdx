...
2. Click **Create** button of the **Argo Rollouts** chart to enter the **Argo Rollouts** installation page.
3. Input the **Name** with `argo-rollouts`, and the **Values** with:
...
4. Click *Create* button to create the **argo-rollouts** application.
