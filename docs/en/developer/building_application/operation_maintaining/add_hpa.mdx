...
1.  Create a YAML file named `hpa.yaml` with the following content:
    ...
    spec:
      ...
      metrics: # [!code callout]
        - type: Resource # [!code callout]
          resource: # [!code callout]
            name: cpu # [!code callout]
            target: # [!code callout]
              type: Utilization # [!code callout]
              averageUtilization: 75 # [!code callout]
    ```
...
#### Updates in autoscaling/v2

autoscaling/v2 supports memory utilization:
