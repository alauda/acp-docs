...
### Updating the Vertical Pod Autoscaler Plugin
1. Log in and navigate to the **Administrators** page.

2. Click **Marketplace** > **Cluster Plugins** to access the **Cluster Plugins** list page.

3. Locate the Alauda Container Platform Vertical Pod Autoscaler cluster plugin, click **Update**, then proceed to the installation page.
