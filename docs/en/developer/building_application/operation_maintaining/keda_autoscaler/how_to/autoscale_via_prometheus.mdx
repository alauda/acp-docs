...
```bash
kubectl get pods -n <your-namespace> -l app=<your-deployment>
```
...
KEDA supports a wide range of additional **scalers**. For more details, see the official documentation: [KEDA Scalers](https://keda.sh/docs/2.16/scalers/).
