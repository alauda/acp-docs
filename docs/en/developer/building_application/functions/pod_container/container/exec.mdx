...
You can enter the internal instance of the container using the docker exec command, allowing you to execute command line operations in the Web console window. Additionally, you can easily upload and download files within the container using the file transfer feature.
...
4. Locate the compute component and click **EXEC** > ***Container Group Name***.
...
1. In the left navigation bar, click **Compute Component** > **Container Group**.
