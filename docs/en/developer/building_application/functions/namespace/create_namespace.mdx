   ...
   <table>
     ...
     <tbody>
       ...
       <tr>
         ...
         <td>Enter custom quotas; for specific input rules, please refer to [Other Quota description](./resource_quota.mdx#other-quotas).</td>
         <td>-</td>
...
7. (Optional) Configure **Pod Security Policies**; please refer to [Pod Security Admission](./security_policies.mdx) for specific details.
