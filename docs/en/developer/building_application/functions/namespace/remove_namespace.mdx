...
## Remove Namespace
**Remove a Namespace from a Project**: Removes a namespace from the current project without deleting its resources. The namespace remains in the cluster and can be imported into other projects via [Import Namespace](./import_namespace.mdx).
