...
After exporting the YAML to a Git code repository, you can refer to [Creating GitOps Applications](/gitops/functions/argocd_application/create_application_platform.mdx) to create a `Custom Application` type of GitOps application across clusters.
