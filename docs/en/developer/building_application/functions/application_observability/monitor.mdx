...
1. **Platform Management**, create a dedicated monitoring dashboard by referring to [Creating Monitoring Dashboard](../../../../observability/monitor/functions/manage_dashboard.mdx#create_dashboard) to create a dedicated monitoring dashboard.
