...
### Creating Deployments by using the CLI
...
### Creating Deployments by using the web console
...
1. **Container** section, refer to the following instructions to configure the relevant information.
   ...
   | **More** > **Health Checks**| <ul><li>**Liveness Probe**: Detect container health (restart if failing)</li><li>**Readiness Probe**: Detect service availability (remove from endpoints if failing)</li></ul>See [Health Check Parameters](/developer/building_application/concepts/healthcheck.mdx#healthcheckparameters).|
...
#### Heath Checks
 ...
 - [Health checks YAML file example](/developer/building_application/concepts/healthcheck.mdx#healthcheckyamlexample)
 - [Health checks configuration parameters in web console](/developer/building_application/concepts/healthcheck.mdx#healthcheckparameters)
...
#### Viewing a Deployment by using web console
...
#### Viewing a Deployment by using the CLI
...
#### Rolling Back a Deployment by using the CLI
...
#### Scaling a Deployment by using the CLI
...
#### Deleting a Deployment by using web console
1. **Container Platform**, and navigate to **Workloads** > **Deployments**.
...
#### Deleting a Deployment by using the CLI
...
Ensure livenessProbe and readinessProbe are correctly configured, and your application's health check endpoints are responding properly. [Troubleshooting probe failures](/developer/building_application/concepts/healthcheck.mdx#healthchecktroubleshooting)
