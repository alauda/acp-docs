...
i18n:
  title:
    ...
    zh: 创建 OAM 应用
title: Creating OAM Applications
---
...
### Prerequisites
1. Install **ACP Application Management with KubeVela**.
...
8. Continue to configure properties, add operational features, and so on.
   ...
   - [Component Concepts](/developer/oam_applications/concepts/component.mdx)

   - [Trait Concepts](/developer/oam_applications/concepts/trait.mdx)
