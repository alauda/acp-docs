...
i18n:
  title:
    ...
    zh: 通过 Chart 创建应用
title: Creating applications by using Chart
---
...
:::warning
- If the template references cross - namespace resources, contact the Administrator for help with creation. Afterward, you can normally [update or delete applications](../application_operation/chart_upgrade.mdx) on web console.
