...
## Importing namespaces by using new web console
...
For project-scoped namespace governance, continue with the namespace pages in this section:

- [Creating Namespaces](./create_namespace.mdx)
- [Updating Namespaces](./manage_namespace.mdx)
- [Deleting/Removing Namespaces](./remove_namespace.mdx)

If you need background information about the product UI entry and scope, see [Web Console](../../../ui/web_console/index.mdx).
