...
When an accelerator implementation such as HAMi, NVIDIA GPU Device Plugin, or NPU Operator is installed in the target cluster, ACP can expose corresponding accelerator quota fields through Kubernetes extended resources.

This page owns namespace quota operations. For accelerator resource names, implementation mapping, and product documentation entry points, refer to [Accelerator Resource Quota](../../../hardware_accelerator/mechanisms/resource-quota.mdx).

### Other Quotas \{#otherquotas}
