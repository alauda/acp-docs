...
For more configuration details regarding workloads via the web console, refer to the [Configure Containers](../application_workloads/deployment_create.mdx#configurecontainers) section.
