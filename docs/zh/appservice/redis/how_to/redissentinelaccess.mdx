...
示例展示了如何使用 [go-redis](https://github.com/redis/go-redis), [Jedis](https://github.com/redis/jedis), [Lettuce](https://github.com/lettuce-io/lettuce-core), [Redisson](https://github.com/redisson/redisson) 客户端访问 Redis（哨兵模式）。更多可选客户端，[查看 Redis 官方客户端推荐](https://redis.io/clients)
...
* 如果您已关闭 **设置密码**，则可无密码访问实例。<br/>
    ...
    **提示**：为确保环境安全，建议您参考 [用户管理]() 设置密码 ，并使用已设置的密码访问 Redis。
...
* go-redis 示例
    ...
    更多更详细配置请参考[官方文档](https://redis.uptrace.dev/guide/go-redis-sentinel.html)
...
* Jedis 示例
    ...
    更多更详细配置请参考[官方文档](https://www.javadoc.io/doc/redis.clients/jedis/5.1.2/redis/clients/jedis/Jedis.html)
...
* Lettuce 示例
    ...
    更多更详细配置请参考[官方文档](https://lettuce.io/core/release/reference/#redis-sentinel)
...
* Redisson 示例
    ...
    更多更详细配置请参考[官方文档](https://github.com/redisson/redisson/wiki/2.-Configuration/#27-sentinel-mode)
