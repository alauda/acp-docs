...
示例展示了如何使用 [go-redis](https://github.com/redis/go-redis), [Jedis](https://github.com/redis/jedis), [Lettuce](https://github.com/lettuce-io/lettuce-core), [Redisson](https://github.com/redisson/redisson) 客户端访问 Redis（集群模式）。更多可选客户端，[查看 Redis 官方客户端推荐](https://redis.io/clients)
...
* go-redis 示例
    ...
    更多更详细配置请参考[官方文档](https://redis.uptrace.dev/guide/go-redis-cluster.html)
...
* Lettuce 示例
    ...
    更多更详细配置请参考[官方文档](https://lettuce.io/core/release/reference/#redis-cluster)
...
* Redisson 示例
    ...
    更多更详细配置请参考[官方文档](https://github.com/redisson/redisson/wiki/2.-Configuration/#24-cluster-mode)
