...
![BigKey检测](/zh/img/44redis-bigkey-inspect-entry.png)
...
![BigKey检测报告查看入口](/zh/img/44redis-bigkey-inspect-report-entry.png)

如果实例中确实存在 BigKey，巡检结果中会中列出`BigKey Top5`项目，如下图所示：

![BigKey检测报告](/zh/img/44redis-bigkey-inspect-report.png)
