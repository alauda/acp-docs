...
5. 参考以下说明完成相关配置。
    ...
    <table border="">
        ...
        <tr>
            ...
            <td><b>设置密码</b></td>
            <td>为保证环境安全，建议您及时设置密码。<ul><li>若不设置密码，可无密码访问实例。</li><li>设置后，请妥善保管您的密码。为降低密码泄漏风险，建议定期 <a href="/appservice/redis/functions/20-user">更新密码</a>。</li></ul></td>
        </tr>
        <tr>
            <td><b>集群外访问</b></td>
