...
metadata:
  ...
  creationTimestamp: 2025-02-08T08:01:26Z
  generation: 1
  labels:
    alert.cpaas.io/cluster: global
    alert.cpaas.io/kind: Node
    ...
    prometheus: kube-prometheus
    rule.cpaas.io/cluster: global
    rule.cpaas.io/name: policy3
    rule.cpaas.io/namespace: cpaas-system
  name: policy3
  namespace: cpaas-system
  resourceVersion: "4528613274"
  uid: 5b4b7330-5e9d-46b7-8666-4ff35b50f25d
  ## 省略无关信息
```
