...
- 当前版本 Devops 产品内 Jenkins 流水线执行记录归档功能不支持使用 Clickhouse，如您需要使用 Jenkins 流水线功能，请谨慎选择 ACP Log Storage with Clickhouse 插件。
- 当前版本 ServiceMesh 服务网格不支持对接 Clickhouse，如您需要使用服务网格功能，请谨慎选择 ACP Log Storage with Clickhouse 插件。
- 当前版本  ACP Log Storage with Clickhouse 插件不支持 IPv6单栈、IPv6双栈业务集群。
