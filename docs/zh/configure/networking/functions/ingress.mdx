---
weight: 10
sourceSHA: 6470ab679cca7c3b585a86f0ca9673809f0006604648fc05e2c76151ec7fdfdd
---
...
| nginx.ingress.kubernetes.io/denylist-source-range                    | CIDR                       | o 可通过 [modsecurity](../how_to/modsecurity.mdx) 实现类似效果                                   |
| nginx.ingress.kubernetes.io/whitelist-source-range                   | CIDR                       | o 可通过 [modsecurity](../how_to/modsecurity.mdx) 实现类似效果                                   |
...
| nginx.ingress.kubernetes.io/enable-modsecurity                       | 布尔值                     | v [modsecurity](../how_to/modsecurity.mdx)                                                       |
| nginx.ingress.kubernetes.io/enable-owasp-core-rules                  | 布尔值                     | v [modsecurity](../how_to/modsecurity.mdx)                                                       |
| nginx.ingress.kubernetes.io/modsecurity-transaction-id               | 字符串                     | v [modsecurity](../how_to/modsecurity.mdx)                                                       |
| nginx.ingress.kubernetes.io/modsecurity-snippet                      | 字符串                     | v [modsecurity](../how_to/modsecurity.mdx)                                                       |
