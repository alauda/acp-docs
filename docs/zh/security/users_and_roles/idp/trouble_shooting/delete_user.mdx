---
weight: 10
sourceSHA: 9a181987499e69c1a77abace05a202145f25b076e04d35d57be2678132e17fa6
---
...
```bash
kubectl delete users -l 'auth.cpaas.io/user.connector_id=<身份提供者名称>,auth.cpaas.io/user.state=deleted'
```
