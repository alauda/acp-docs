...
- Clickhouse 日志插件在新的版本催熟至 Beta级别，但无法支持平滑升级。如果平台上部署了 Clickhouse 日志插件，请在升级前卸载此插件，在业务集群完成升级后再重新安装。
- Costmanager 插件和 Kubecost 插件在 4.0 版本下线，如果平台上部署了 Costmanager 插件和 Kubecost 插件，请在升级前卸载此插件。
