...
3. 在表单页面填写 **名称**、**镜像** 等必要参数，具体参数及配置请参考 [创建虚拟机](/virtualization/virtualization/virtual_machine/functions/create_virtual_machine.mdx)。
...
2. 单击 **创建虚拟机**。
3. 在表单页面填写必要参数。其中，镜像选择导出的 Windows 镜像，具体详细的参数及配置请参考 [创建虚拟机](/virtualization/virtualization/virtual_machine/functions/create_virtual_machine.mdx)。
