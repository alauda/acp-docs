...
4. 将下述自定义组件的 YAML 文件复制到页面中。其中，本文档的示例 YAML 仅展示了如何使用 annotations 自定义组件的名称、标签及描述的样式，没有具体的功能，YAML 中具体字段说明请参考 [CUE](/application/create_applications/create_oam_applications/concepts/cue.mdx)。
