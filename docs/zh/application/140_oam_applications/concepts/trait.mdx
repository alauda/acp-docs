...
|---|---|
|**添加**|添加一个键值对形式的环境变量。|
|**引用**|引用 **配置字典或 Opaque、用户名/密码类型的保密字典** 中的字段作为环境变量，相关配置参数请参考 [配置字典](/application/140_oam_applications/concepts/component.md) 或 [保密字典](/application/140_oam_applications/concepts/component.md)。
...
健康检查参数说明请参考 [健康检查](/application/140_oam_applications/concepts/component.md)。
...
具体参数说明请参考 [配置水平伸缩](/application/140_oam_applications/concepts/component.md)。
...
具体参数说明请参考 [创建入站规则](/application/140_oam_applications/concepts/component.md)。
...
为 Pod 添加资源请求和限制，具体的请求与限制说明请参考 [资源请求与资源限制](/application/140_oam_applications/concepts/component.md)。
